    ...
    try {
      const newProperty = await prisma.property.create({
        data: {
          ...
          area: property.area,
          balconyTypes: property.balconyTypes,
          price: property.price,
          apartmentOptions: property.apartmentOptions,
          ...
          locationBenefits: property.locationBenefits,
          differentials: property.differentials,
